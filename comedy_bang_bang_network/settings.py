"""
Django settings for comedy_bang_bang_network project.
...
ROOT_URLCONF = 'comedy_bang_bang_network.urls'
...
WSGI_APPLICATION = 'comedy_bang_bang_network.wsgi.application'
